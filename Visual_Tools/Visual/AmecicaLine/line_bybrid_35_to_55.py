...
class Line:
    ...
    # 判定条件
    def jug_condition(self, date, hour, minute):
        flag = False
                ...
                while len(data) > interval:
                    for time in [55, 50, 45, 40, 35]:
                        ...
                        if obj.jug_condition(date, 9, time) and len(sub_data_day) == no:
                            ...
                            obj.draw_America_Line(sub_data, sub_data_day, pixel, no, count, table_name, code, profit,
                                                  date)
                            # break
                        else:
                            break
...
if __name__ == '__main__':
    ...
    pixel = 64
    kline = 'index_min5'
    table_name = 'A_America_line_hybrid_35_to_55_' + kline
    obj = Line()

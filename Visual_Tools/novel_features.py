...
def n_RSI(data, N1=6, N2=12, N3=24):
    ...
    data['sRSI_20_cross_lRSI'] = (data['RSI1'] < 20.0) & (data['sRSI_z'] < data['lRSI_z']) & (data['RSI1'] > data['RSI3'])
    ...
    data['sRSI_80_cross_lRSI'] = (data['RSI1'] > 80.0) & (data['RSI1'] < data['RSI3']) & (data['sRSI_z'] > data['lRSI_z'])
...
def s_MA(data):
    ...
    data['last_ma5'] = data['ma5'].shift(-1)
    data['last_ma10'] = data['ma10'].shift(-1)
    data['last_ma20'] = data['ma20'].shift(-1)
    data['last_ma30'] = data['ma30'].shift(-1)
    data['last_ma60'] = data['ma60'].shift(-1)
    data['last_ma120'] = data['ma120'].shift(-1)
    data['last_ma250'] = data['ma250'].shift(-1)
    data['angle_ma5']=(1-data['ma5']/data['last_ma5'])*1000
    data['angle_ma10'] =(1-data['ma10'] / data['last_ma5'])*1000
    data['angle_ma20'] = (1-data['ma20'] / data['last_ma20'])*1000
    data['angle_ma30'] = (1-data['ma30'] / data['last_ma30'])*1000
    data['angle_ma60'] = (1-data['ma60'] / data['last_ma60'])*1000
    data['angle_ma120'] = (1-data['ma120'] / data['last_ma120'])*1000
    data['angle_ma250'] = (1-data['ma250'] / data['last_ma250'])*1000
    data['o_c']=(1-data['close']/data['open'])*1000
    data['lc_o']=(1-data['last_close']/data['open'])*1000
    data['lo_o'] = (1-data['last_open'] / data['open'])*1000
    data['lo_c'] = (1-data['last_open'] / data['close'])*1000
    data['p_close48'] = data['close'].shift(48)
    data['change_r_next48'] = (1-data.p_close48 / data.close)*1000
    # data['lable']=data.change_r_next48>0
    # data.drop(['p_close48','change_r_next48','last_close', 'last_open', 'last_ma5', 'last_ma10', 'last_ma20', 'last_ma30', 'last_ma60', 'last_ma120','last_ma250','ma5','ma10','ma20','ma30','ma60','ma120','ma250','open','high','low','close','volume','amount','up','down'], axis=1, inplace=True)
    return data
...
def n_MA(data):
    ...
    data['last_volume'] = last_n(data, 1, 'amount')
    ...
    data['last2_volume'] = last_n(data, 2, 'amount')
    ...
    data['last3_volume'] = last_n(data, 3, 'amount')
    ...
    data['last4_volume'] = last_n(data, 4, 'amount')
    ...
    data['ma30'] = data['close'].rolling(window=30).mean()
    data['ma60'] = data['close'].rolling(window=60).mean()
    data['v_ma5'] = data['amount'].rolling(window=5).mean()
    data['v_ma10'] = data['amount'].rolling(window=10).mean()
    data['v_ma20'] = data['amount'].rolling(window=20).mean()
    data['v_ma30'] = data['amount'].rolling(window=30).mean()
    data['v_ma60'] = data['amount'].rolling(window=60).mean()
    data['vv_ma5'] = data['amount'].rolling(window=5).sum()
    data['vv_ma10'] = data['amount'].rolling(window=10).sum()
    data['vv_ma20'] = data['amount'].rolling(window=20).sum()
    data['vv_ma30'] = data['amount'].rolling(window=30).sum()
    data['vv_ma60'] = data['amount'].rolling(window=60).sum()
    ...
    data['p_close2'] = next_n(data, 2, 'close')
    data['p_close3'] = next_n(data, 3, 'close')
    data['p_close4'] = next_n(data, 4, 'close')
    data['p_close16'] = next_n(data, 16, 'close')
    data['p_close48'] = next_n(data, 48, 'close')
    data['change_r_next']=(data.p_close-data.close)/data.close
    data['change_r_next2'] = (data.p_close2 - data.close) / data.close
    data['change_r_next3'] = (data.p_close3 - data.close) / data.close
    data['change_r_next4'] = (data.p_close4 - data.close) / data.close
    data['change_r_next16'] = (data.p_close16 - data.close) / data.close
    data['change_r_next48'] = (data.p_close48 - data.close) / data.close
    ...
    data['volume_r'] = data['amount'] / data['last_volume']

    # 成交量距离

    data['v_dt_ma5'] = data['amount'] / data['v_ma5']
    data['v_dt_ma10'] = data['amount'] / data['v_ma10']
    data['v_dt_ma20'] = data['amount'] / data['v_ma20']
    data['v_dt_ma30'] = data['amount'] / data['v_ma30']
    data['v_dt_ma60'] = data['amount'] / data['v_ma60']

    data['vv_dt_ma5'] = data['amount'] / data['vv_ma5']
    data['vv_dt_ma10'] = data['amount'] / data['vv_ma10']
    data['vv_dt_ma20'] = data['amount'] / data['vv_ma20']
    data['vv_dt_ma30'] = data['amount'] / data['vv_ma30']
    data['vv_dt_ma60'] = data['amount'] / data['vv_ma60']
    ...
    # k金叉均线数量
    data['number_close_up_mean'] = data['close_up_ma5'].astype('int') + data['close_up_ma10'].astype('int') + data['close_up_ma20'].astype('int') + data[
        'close_up_ma30'].astype('int') + data['close_up_ma60'].astype('int')

    # k死叉均线数量
    data['number_close_down_mean'] = data['close_down_ma5'].astype('int') + data['close_down_ma10'].astype('int') + data['close_down_ma20'].astype('int') + data[
...
def n_MACD(data, short=12, long=26, mid=9):
    ...
    data['macd_over_last_macd'] = (data['macd'] > data['macd_z']) & (data['macd_z'] < data['macd_q']) & (data['dif'] > 0) & (data['macd'] < 0)
    data = data[::-1]

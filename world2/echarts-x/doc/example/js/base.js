$(function () {
    ...
    function echart_1() {
        ...
        option = {
            ...
            legend: {
                x: 'center',
                y: '15%',
                data: ['平安银行', '白云机场', '重庆啤酒', '东风汽车', '三一重工', '中国联通', '中信证券', '保利地产', '格力电器'],
                icon: 'circle',
                textStyle: {
                    color: '#fff',
                }
    ...
    function echart_0() {
        ...
        function showProvince() {
                var geoCoordMap = {
                    '正定国际机场': [114.707705, 38.287644],
                    '山海关机场': [119.729692, 39.972725],
                    '邯郸机场': [114.437921, 36.531179],
                    '邢台机场': [114.487896, 37.085685],
                    '保定机场': [115.534977, 38.881796],
                };
                var data = [{
                        name: '正定国际机场',
                        value: 100
    ...
    function echart_3() {
        ...
        option = {
            ...
            legend: {
                data:['铁路运输业就业人员数','公路运输业就业人员数','水上运输业就业人员数','航空运输业就业人员数','管道运输业就业人员数','装卸搬运和其他运输服务业就业人员数','等外公路公路里程'],
                textStyle:{
                    color: '#fff'
                },
                top: '4%'
    ...
    function echart_8() {
        ...
        option = {
            ...
            legend: {
                data:['货物周转量','铁路货物周转量','国家铁路货物周转量','地方铁路货物周转量','合资铁路货物周转量','公路货物周转量','水运货物周转量'],
                textStyle:{
                    color: '#fff'
                },
                top: '4%'
            ...
            series: [
                {
                    name:'货物周转量',
                    type:'line',
                    data:[10604.96, 11674.06, 12684.47, 12007.28, 12332.68]
                },
                {
                    name:'铁路货物周转量',
                    type:'line',
            ...
            series: [
                {
                    ...
                    data:[
                        {value:90392.39, name:'2016年快递量(90392.39万件)'},
                    ]
                },
                {
                    name:'快递量(万件)',
                    ...
                    data:[
                        {value:464.43, name:'国际及港澳台'},
                        {value:68575.6, name:'国内异地'},
                        {value:21352.36, name:'国内同城'},
                    ]
                },
                {
                    name:'快递量(万件)',
                    ...
                    data:[
                        {value:54911.94, name:'2015年快递量(54911.94万件)'},
                    ]
                },
                {
                    name:'快递量(万件)',
                    ...
                    data:[
                        {value:278.5, name:'国际及港澳台'},
                        {value:37111.03, name:'国内异地'},
                        {value:17522.41, name:'国内同城'},
                    ]
                },
                {
                    name:'快递量(万件)',
                    ...
                    data:[
                        {value:34019.15, name:'2014年快递量(34019.15万件)'},
                        // {value:20755.74, name:'2013年快递量(20755.74万件)'}
                    ]
                },
                {
                    name:'快递量(万件)',
                    ...
                    data:[
                        {value:163.72, name:'国际及港澳台'},
                        {value:26841.29, name:'国内异地'},
                        {value:7014.14, name:'国内同城'},
                        // {value:129.65, name:'2013年国际及港澳台快递量(万件)'},
                        // {value:18072.54, name:'2013年国内异地快递量(万件)'},
                        // {value:2553.55, name:'2013年国内同城快递量(万件)'},
                    ]
                },
                {
                    name:'快递量(万件)',
                ...
                },
                {
                    ...
                    data:[
                        {value:129.65, name:'国际及港澳台'},
                        {value:18072.54, name:'国内异地'},
                        {value:2553.55, name:'国内同城'},
                        // {value:129.65, name:'2013年国际及港澳台快递量(万件)'},
                        // {value:18072.54, name:'2013年国内异地快递量(万件)'},
                        // {value:2553.55, name:'2013年国内同城快递量(万件)'},
                    ]
            ...
            series: [
                {
                    ...
                    data:[
                        {value:145.18, name:'2016年公路营运拥有量(145.18万辆)'},
                    ]
                },
                {
                    name:'汽车拥有量(万辆)',
